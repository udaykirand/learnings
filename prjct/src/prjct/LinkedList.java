...
public class LinkedList {
	 ...
	 * slow and fast will point to same node i.e. they meet * On the other hand
	 * if fast will point to null or next node of * fast will point to null then
	...
	public boolean isCyclic() {
		...
		while (fast != null && fast.next != null) {
			...
			System.out.println("Fast - "+fast);					// LinkedList is cyclic
